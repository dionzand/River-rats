...
2. Under *Build and deployment*, choose **Deploy from a branch**, pick this branch and the
   `/ (root)` folder, and save. (A workflow in `.github/workflows/pages.yml` is included if you
   would rather deploy with Actions — enable it by choosing **GitHub Actions** as the source.)
